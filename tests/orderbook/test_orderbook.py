...
def make_market_order(
    book: OrderBook, side: str, qty: str, trade_id: str, verbose: bool = False
):
...
class TestOrderCancellation:
    ...
    def test_cancel_order_from_middle_of_list(self):
        ...
        book = OrderBook()
        _trades, _order1 = make_limit_order(book, SIDE_BID, "5", "100", "B1")
        _trades, order2 = make_limit_order(book, SIDE_BID, "5", "100", "B2")
        _trades, _order3 = make_limit_order(book, SIDE_BID, "5", "100", "B3")
...
class TestOrderModification:
    ...
    def test_modify_order_quantity_increase(self):
        ...
        book.modify_order(
            order_id, {"side": SIDE_BID, "quantity": "10", "price": "100"}
        )
    ...
    def test_modify_order_loses_priority_on_price_change(self):
        ...
        book.modify_order(
            order1["order_id"], {"side": SIDE_BID, "quantity": "5", "price": "101"}
        )
    ...
    def test_modify_order_quantity_increase_moves_to_tail(self):
        ...
        book.modify_order(
            order1["order_id"], {"side": SIDE_BID, "quantity": "5", "price": "100"}
        )
    ...
    def test_modify_order_with_custom_time(self):
        ...
        book.modify_order(
            order["order_id"],
            {"side": SIDE_BID, "quantity": "10", "price": "100"},
            time=5000,
        )
...
class TestEdgeCases:
    ...
    def test_modify_order_to_same_values(self):
        ...
        book.modify_order(
            order["order_id"], {"side": SIDE_BID, "quantity": "10", "price": "100"}
        )
...
class TestComplexScenarios:
    ...
    def test_full_trading_session(self):
        ...
        # Modify an order
        book.modify_order(
            order1["order_id"], {"side": SIDE_BID, "quantity": "15", "price": "99"}
        )
